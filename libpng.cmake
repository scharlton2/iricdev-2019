...
set(BUILD_OPTIONS
  ...
  -DZLIB_INCLUDE_DIR:PATH=${CTEST_SCRIPT_DIRECTORY}/lib/install/zlib-$ENV{ZLIB_VER}/include
)

if("${CONF_DIR}" STREQUAL "debug")
  list(APPEND BUILD_OPTIONS "-DZLIB_LIBRARY:PATH=${CTEST_SCRIPT_DIRECTORY}/lib/install/zlib-$ENV{ZLIB_VER}/lib/zlibd.lib")
else()
  list(APPEND BUILD_OPTIONS "-DZLIB_LIBRARY:PATH=${CTEST_SCRIPT_DIRECTORY}/lib/install/zlib-$ENV{ZLIB_VER}/lib/zlib.lib")
endif()
