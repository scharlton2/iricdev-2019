...
set(CTEST_BINARY_DIRECTORY "${CTEST_SCRIPT_DIRECTORY}/lib/build/cgnslib-adf-${VER}")
...
if (WIN32)
  file(COPY "${CTEST_SCRIPT_DIRECTORY}/lib/build/cgnslib-adf-${VER}/src/${CONF_DIR}/cgnsdll.dll" DESTINATION "${CTEST_SCRIPT_DIRECTORY}/lib/build/cgnslib-adf-${VER}/src")
endif()
...
file(RENAME
  ${CTEST_SCRIPT_DIRECTORY}/lib/install/cgnslib-adf-${VER}/${CONF_DIR}/include/cgnslib_f.h
  ${CTEST_SCRIPT_DIRECTORY}/lib/install/cgnslib-adf-${VER}/${CONF_DIR}/include/cgnslib_f.h.orig
)
