...
if("${CMAKE_SYSTEM_NAME}" STREQUAL "Windows")
  list(APPEND BUILD_OPTIONS "-DVTK_Group_Qt:BOOL=ON")
  list(APPEND BUILD_OPTIONS "-DModule_vtkGUISupportQtOpenGL:BOOL=ON")
  list(APPEND BUILD_OPTIONS "-DModule_vtkIOExportOpenGL2:BOOL=ON")
endif()


if("${CMAKE_SYSTEM_NAME}" STREQUAL "Linux")
  #set(PREFIX_PATH "$ENV{HOME}/Qt5.5.1/5.5/gcc_64")
  #set(PREFIX_PATH "$ENV{HOME}/Qt/5.14.2/gcc_64")
  ...
  list(APPEND BUILD_OPTIONS "-DVTK_Group_Rendering:BOOL=OFF")
  list(APPEND BUILD_OPTIONS "-DVTK_Group_StandAlone:BOOL=ON")
  ##list(APPEND BUILD_OPTIONS "-DVTK_Group_Rendering:BOOL=OFF")
  ##list(APPEND BUILD_OPTIONS "-DVTK_Group_Rendering:BOOL=OFF")
  if(NOT EXISTS "${CTEST_SCRIPT_DIRECTORY}/lib/src/VTK-${VER}/ThirdParty/exodusII/vtkexodusII/src/ex_create_par.c.orig")
    file(RENAME ${CTEST_SCRIPT_DIRECTORY}/lib/src/VTK-${VER}/ThirdParty/exodusII/vtkexodusII/src/ex_create_par.c
         ${CTEST_SCRIPT_DIRECTORY}/lib/src/VTK-${VER}/ThirdParty/exodusII/vtkexodusII/src/ex_create_par.c.orig
    )
    file(COPY ${CTEST_SCRIPT_DIRECTORY}/patches/VTK-${VER}/ThirdParty/exodusII/vtkexodusII/src/ex_create_par.c
         DESTINATION ${CTEST_SCRIPT_DIRECTORY}/lib/src/VTK-${VER}/ThirdParty/exodusII/vtkexodusII/src/.
    )
  endif()
endif()
